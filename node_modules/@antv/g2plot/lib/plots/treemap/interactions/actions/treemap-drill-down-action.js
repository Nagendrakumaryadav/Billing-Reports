...
var TreemapDrillDownAction = /** @class */ (function (_super) {
    ...
    TreemapDrillDownAction.prototype.getButtonCfg = function () {
        return deep_assign_1.deepAssign(this.breadCrumbCfg, this.cfg);
    };
    ...
    TreemapDrillDownAction.prototype.drawBreadCrumbGroup = function () {
        ...
        historyCache.forEach(function (record, index) {
            ...
            var textShape = _this.breadCrumbGroup.addShape({
                ...
                attrs: tslib_1.__assign(tslib_1.__assign({ text: record.name }, config.textStyle), { x: left, y: 0 }),
            });
    ...
    TreemapDrillDownAction.prototype.resetPosition = function () {
        ...
        var matrix = matrix_util_1.ext.transform(null, [['t', point.x + PADDING_LEFT, point.y + bbox.height + PADDING_TOP]]);
    ...
    // reset 历史记录，并重绘面包屑
    TreemapDrillDownAction.prototype.reset = function (historyCache) {
        var view = this.context.view;
        if (!util_1.isArray(this.historyCache) || this.historyCache.length <= 0) {
            return;
        }
