...
function geometry(params) {
    ...
    // edge view
    var edgeView = chart.createView({ id: 'views' });
    edgeView.data(edges);
    geometries_1.edge({
        chart: edgeView,
        // @ts-ignore
    ...
    var nodeView = chart.createView({ id: 'nodes' });
    nodeView.data(nodes);
...
function adaptor(params) {
    ...
    return utils_1.flow(geometry, common_1.interaction, animation, common_1.theme
    // ... 其他的 adaptor flow
    )(params);
}
